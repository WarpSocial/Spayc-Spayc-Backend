...
class PriorityBehavior extends Behavior {
    ...
    public function beforeSave(Event $event, Entity $entity, ArrayObject $options) {
        ...
        if ($entity->isNew()) {
            ...
            if ($newOrder === null) {
                ...
                $this->_sync(
                        [$orderField => $this->_getUpdateExpression('+')], [$orderField . ' >=' => $newOrder], $newScope
                );
            }
            ...
            if ($newScope && $newScope != $oldScope) {
                ...
                $this->_sync(
                        [$orderField => $this->_getUpdateExpression('-')], [$orderField . ' >' => $oldOrder], $oldScope
                );
                ...
                if ($newOrder === null) {
                    ...
                    $entity->set(
                            $orderField, $this->_getHighestOrder($newScope) + 1
                    );
    ...
    public function beforeDelete(Event $event, Entity $entity) {
        ...
        $this->_sync(
                [$orderField => $this->_getUpdateExpression('-')], [$orderField . ' >' => $order], $scope
        );
    }
    ...
    public function setOrder(array $records) {
        ...
        $return = $table->getConnection()->transactional(
            ...
            foreach ($records as $record) {
                ...
                $r = $table->save(
                        $record, ['atomic' => false, 'checkRules' => false]
                );
                if ($r === false) {
                    return false;
                }
