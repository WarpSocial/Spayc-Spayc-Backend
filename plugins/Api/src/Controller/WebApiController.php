    ...
    public function addCategory() {
        $cats = [
            ...
            'Sports' => ['title'=>'Sports','code'=>'1F3BD','child'=>[
                ...
                ["title" => "Bull Riding", "code" => ""],
                ["title" => "Competitions", "code" => ""],
