                ...
                <tbody>
                  ...
                  <tr>
                    <td style="width: 100%; float: left; text-align: center;margin-top: 40px;margin-bottom: 40px;">
                      <a href="<?php echo $this->Url->build('/api/reset-password/'.$user->forgot_password_token.'/'. urlencode($user->email).'.html',true); ?>" style="font-weight: normal; background: #1a4c59; color:#fff; border-radius: 24px; padding: 15px 30px; text-decoration: none;margin: 0 auto; text-align: center;font-family: arial;">Reset Password</a>
                    </td>
                  </tr>
                  <tr>
                    <td>
