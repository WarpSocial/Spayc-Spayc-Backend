...
/**
 * PhysicalLocationFixture
 *
 */
class PhysicalLocationFixture extends TestFixture
{
     ...
     * @var string
     */
    public $table = 'physical_location';
    ...
    public $fields = [
        ...
        'updated_by' => ['type' => 'biginteger', 'length' => 20, 'default' => null, 'null' => false, 'comment' => null, 'precision' => null, 'unsigned' => null, 'autoIncrement' => null],
        '_constraints' => [
