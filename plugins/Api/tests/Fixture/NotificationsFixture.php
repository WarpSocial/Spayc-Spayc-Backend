...
class NotificationsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'notification_type' => ['type' => 'string', 'length' => 20, 'default' => 'NULL::character varying', 'null' => true, 'collate' => null, 'comment' => null, 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'requested_by' => 1,
            'requested_to' => 1,
            'notification_type' => 'Lorem ipsum dolor ',
            'status' => 'Lorem ipsum dolor ',
            'message' => 'Lorem ipsum dolor sit amet',
            'created' => 1519809411,
            'modified' => 1519809411,
            'date_time' => 1519809411,
            'spayc_id' => 1
        ],
    ];
}
