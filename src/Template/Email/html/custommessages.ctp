        ...
        <tbody>
          <tr style="border:0;border-collapse:collapse;background-color:#1a4c59;">
              <td style="width:100%;margin:0;padding:7px 15px;font-size:25px;color: #fff;">
                <img src="<?php echo Configure::read('App.BASE_URL').'images/logo.png'; ?>" alt="Warp" style="text-align:center; display: block; margin: 0 auto;">
              </td>
          </tr>
          <tr>
                ...
                <tbody>
                  <tr>
                    <td style="line-height:23px;">
                      <div style="margin-top: 25px; color:#272727; font-size: 14px;">Hi <?php echo ucwords($user['name']);?>,</div>
                      <div style="color:#333333; margin-top:10px; font-size: 13px;"><?php echo ucwords($user['message']);?></div>
                    </td>
                  </tr>                  
                  <tr>
                    <td>
