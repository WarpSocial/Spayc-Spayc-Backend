...
<head>
  ...
  <?= $this->Html->meta('icon') ?>
  <?php echo $this->Html->css(['/apidoc/vendor/bootstrap.min.css','/apidoc/vendor/prettify.css','/apidoc/css/style.css']); ?>
  <?php echo $this->Html->script(['/apidoc/vendor/polyfill.js']); ?>
</head>
<body>
...
<script data-main="<?php echo $this->Url->build('/',true) ?>apidoc/main.js" src="<?php echo $this->Url->build('/',true) ?>apidoc/vendor/require.min.js"></script>
</body>
</html>
