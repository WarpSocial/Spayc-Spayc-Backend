...
class AdvertisementFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'price' => ['type' => 'decimal', 'length' => 12, 'default' => null, 'null' => true, 'comment' => null, 'precision' => 2, 'unsigned' => null],
        ...
        'views' => ['type' => 'biginteger', 'length' => 20, 'default' => null, 'null' => true, 'comment' => null, 'precision' => null, 'unsigned' => null, 'autoIncrement' => null],
        'balance' => ['type' => 'biginteger', 'length' => 20, 'default' => null, 'null' => true, 'comment' => null, 'precision' => null, 'unsigned' => null, 'autoIncrement' => null],
        '_indexes' => [
            'advertisement_created_idx' => ['type' => 'index', 'columns' => ['created'], 'length' => []],
        ],
        '_constraints' => [
