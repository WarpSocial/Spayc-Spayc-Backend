define({ "api": [
  ...
  },
  {
    ...
    "description": "<p>Get list of spayces which user has been joined and spayces must be with 1 miles.Spaycs must not be expired according to the spayc end date.Listing will be ordered on distance and if distance will be same then on created.</p> ",
    "header": {
      "fields": {
        "Header": [
          {
