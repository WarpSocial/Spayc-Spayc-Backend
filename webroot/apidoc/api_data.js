define({ "api": [
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "friend_status",
            "description": "<p>Friend status and status must be either one from following &#39;Blocked&#39; (Required).</p> "
          }
        ]
      }
    },
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "friend_status",
            "description": "<p>Friend status and status must be either one from following &#39;Unblock&#39; (Required).</p> "
          }
        ]
      }
    },
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "friend_status",
            "description": "<p>Friend status and status must be either one from following &#39;Unfriend&#39; (Required).</p> "
          }
        ]
      }
    },
  ...
  },
  {
    ...
    "description": "<p>super admin or admin can ban spayc member who has not rights of admin and super admin could ban admin privileges member too.</p> ",
    "header": {
      "fields": {
        "Header": [
          {
