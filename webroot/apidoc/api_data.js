define({ "api": [
      ...
      "fields": {
        "Header": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "timezone",
            "description": "<p>User current time zone ex: America/New_York.</p> "
          }
        ]
      }
    },
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "end_date",
            "description": "<p>End date with time in format YYYY-MM-DD H:i:s (Optional).</p> "
          },
          {
            "group": "Parameter",
            "type": "Integer",
            "optional": false,
            "field": "repeat_type",
            "description": "<p>Repeat type value must be any one 1=&gt;daily,2=&gt;weekly,3=&gt;custom and default will be daily (Required).</p> "
          },
          {
            "group": "Parameter",
            "type": "String",
            "optional": false,
            "field": "day_of_week",
            "description": "<p>Day of week is required when repeat type will be 2=&gt;weekly and value can be comma separated and value will be 0=&gt;Sun,1=&gt;Mon,2=&gt;Tue,3=&gt;Wed,4=&gt;Thu,5=&gt;Fri,6=&gt;Sat.</p> "
          },
          {
            "group": "Parameter",
            "type": "String",
            "optional": false,
            "field": "repeat_date",
            "description": "<p>Repeate date is required when repeat type will be 3=&gt;custom and value can be comma separated in format MM-DD-YYYY.</p> "
          },
          {
            "group": "Parameter",
            "type": "String",
          ...
          },
          {
            ...
            "optional": false,
            "field": "payment_type",
            "description": "<p>payment option and value must be Free,Paid or NA(Required).</p> "
          },
          {
            "group": "Parameter",
            "type": "String",
            "optional": false,
            "field": "ticket_url",
            "description": "<p>Payment ticket url must be comma separated (Optional).</p> "
          },
          {
            "group": "Parameter",
            "type": "Integer",
  ...
  {
    "type": "get",
    "url": "/events-image.json?events=:matrix_room_id",
    "title": "Events(Warp) image",
    "version": "0.1.0",
    "name": "getEventsImage",
    "group": "Spayc",
    "permission": [
    ...
    "description": "<p>Get the list of images of warps.</p> ",
    "header": {
      "fields": {
        "Header": [
          {
        ...
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "events",
            "description": "<p>*Matrix room id and in case of more than one id value must be comma separated(Required).</p> "
          }
        ]
      }
    },
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "data",
            "description": "<p>List of events image.</p> "
          }
        ]
      },
      "examples": [
  ...
  {
    "type": "get",
    "url": "/joined-spayc.json?",
    "title": "User Joined Warp",
    "version": "0.1.0",
    "name": "getJoinedSpayc",
    "group": "Spayc",
    "permission": [
    ...
    "description": "<p>Get the list warp to whom user has been joined the warp.</p> ",
    "header": {
      "fields": {
        "Header": [
          {
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "message",
            "description": "<p>List of Joined warp.</p> "
          },
          {
            "group": "Success 200",
            "type": "Object",
  ...
  {
    "type": "get",
    "url": "/rooms-image.json?limit=:limit&page=:page",
    "title": "Spayc Images",
    "version": "0.1.0",
    "name": "getRoomzImage",
    "group": "Spayc",
    ...
    "description": "<p>Get list of images of joined and subscribed spayc.</p> ",
    "header": {
      "fields": {
        "Header": [
          {
        ...
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "limit",
            "description": "<p>*Limit of records if not default will be 50.</p> "
          },
          {
            "group": "Parameter",
            "type": "Integer",
      ...
      "fields": {
        "query": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "limit",
            "description": "<ul> <li>Limit in query string (Optional).</li> </ul> "
          },
          {
            "group": "query",
            "type": "Datetime",
            "optional": false,
            "field": "date",
            "description": "<ul> <li>date format must in timestamp (optional).</li> </ul> "
          },
          {
            "group": "query",
            "type": "Integer",
            "optional": false,
            "field": "radius",
            "description": "<ul> <li>distance in Miles(optional).</li> </ul> "
          },
          {
            "group": "query",
            "type": "String",
            "optional": false,
            "field": "payment_type",
            "description": "<ul> <li>value must be toggling between free and paid(Optional).</li> </ul> "
          },
          {
            "group": "query",
            "type": "String",
            "optional": false,
            "field": "group_type",
            "description": "<ul> <li>Group type must be any one from the following (Public|Private) (Optional).</li> </ul> "
          },
          {
            "group": "query",
            "type": "String",
            "optional": false,
            "field": "latitude",
            "description": "<ul> <li>Latitude is required in query string(Optional in case of created, joined).</li> </ul> "
          },
          {
            "group": "query",
            "type": "String",
            "optional": false,
            "field": "longitude",
            "description": "<ul> <li>Longitude is required in query string(Optional in case of created, joined).</li> </ul> "
          },
          {
            "group": "query",
            "type": "String",
            "optional": false,
            "field": "list_by",
            "description": "<ul> <li>List by is optional in query string(created|joined|all).</li> </ul> "
          },
          {
            "group": "query",
            "type": "Number",
            "optional": false,
            "field": "user_id",
            "description": "<ul> <li>User id  of any user and if id is not available it will get the logged user data(Required).</li> </ul> "
          },
          {
            "group": "query",
            "type": "String",
            "optional": false,
            "field": "categories",
            "description": "<ul> <li>List of comma separeted categoires (Optional).</li> </ul> "
          },
          {
            "group": "query",
            "type": "String",
            "optional": false,
            "field": "friends",
            "description": "<ul> <li>Value must be either yes or no (Optional).</li> </ul> "
          },
          {
            "group": "query",
            "type": "String",
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "radius",
            "description": "<p>Redius between required two points.</p> "
          },
          {
            "group": "Parameter",
            "type": "String",
            "optional": false,
            "field": "payment_type",
            "description": "<p>value must be toggling between free and paid(Optional).</p> "
          },
          {
            "group": "Parameter",
            "type": "Datetime",
            "optional": false,
            "field": "current_date",
            "description": "<p>Client current date and date format must be timestamp (Optional).</p> "
          },
          {
            "group": "Parameter",
            "type": "String",
  ...
  {
    "type": "post",
    "url": "/reported-warp.json",
    "title": "Report About Warp",
    "version": "0.1.0",
    "name": "postReportsWarp",
    "group": "Spayc",
    "permission": [
      {
        "name": "Private User"
    ...
    "description": "<p>Report about a warp.</p> ",
    "header": {
      "fields": {
        "Header": [
          {
        ...
        "Error 4xx": [
          {
            ...
            "optional": false,
            "field": "You",
            "description": "<p>have already reported about this warp.Admin will take care about this reports.</p> "
          },
          {
            "group": "Error 4xx",
            "type": "Object",
  ...
  {
    "type": "put",
    "url": "/update-comment/:matrix_room_id.json",
    ...
    "description": "<p>Update comment placed inside room.Append matrix room id in url</p> ",
    "success": {
      "fields": {
        "Success 200": [
          {
          ...
          },
          {
            ...
            "optional": false,
            "field": "message",
            "description": "<p>Request proccess successfully.</p> "
          }
        ]
      },
      "examples": [
  ...
  {
    "type": "get",
    "url": "/spayc-details.json?id=:id&latitude=:lat&longitude=:long&date=:timestamp",
    "title": "About Spayc",
    "version": "0.1.0",
    "name": "spaycDetails",
    "group": "Spayc",
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "date",
            "description": "<p>Timestamp value for which date you want to show the details (Optional).</p> "
          }
        ]
      }
    },
    ...
    "sampleRequest": [
      {
        "url": "http://spayc-staging.kiwireader.com/api/spayc-details.json?id=:id&latitude=:lat&longitude=:long&date=:timestamp"
      }
    ],
    "error": {
      "fields": {
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "full_name",
            "description": "<p>display name value (optional).</p> "
          },
          {
            "group": "Parameter",
            "type": "String",
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "fully_name",
            "description": "<p>Full name (Optional).</p> "
          },
          {
            "group": "Parameter",
            "type": "Date",
  ...
  },
  {
    ...
    "description": "<p>Search users|spaycs|hashtags details by requesting parameters Note: distance key not came in spayc list in case of no latitude and longitude.Daata will filter for next 14 days in case of keywork value available</p> ",
    "header": {
      "fields": {
        "Header": [
          {
  ...
  },
  {
    ...
    "title": "Update User Categories",
    "version": "0.1.0",
    "name": "postUserCategories",
    "group": "User",
    "permission": [
      {
        "name": "Private"
    ...
    "description": "<p>add list of comma separated categories id.</p> ",
    "header": {
      "fields": {
        "Header": [
          {
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "attachment",
            "description": "<p>Any attached document(Optional).</p> "
          }
        ]
      }
    },
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "message",
            "description": "<p>Your feedback message has been sent successfully</p> "
          }
        ]
      },
      "examples": [
  ...
  },
  {
    ...
    "description": "<p>add setting for ghost mode.Any one key is required.</p> ",
    "header": {
      "fields": {
        "Header": [
          {
        ...
        "Parameter": [
          {
            ...
            "type": "Integer",
            "optional": false,
            "field": "ghost_mode_search",
            "description": "<p>Ghost mode setting for search value must be either 0 or 1 (Optional|required).</p> "
          },
          {
            "group": "Parameter",
            "type": "Integer",
            "optional": false,
            "field": "ghost_mode_map",
            "description": "<p>user Ghost mode setting for map value must be either 0 or 1 (Optional|required).</p> "
          }
        ]
      }
    },
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "message",
            "description": "<p>Ghost mode setting change successfully.</p> "
          }
        ]
      },
      "examples": [
