...
$scraperRootUrlToken = [
    ...
    'eventbritetoken'=> \Cake\Core\Configure::read('EVENTBRITE_AUTH_KEY','KJWSF5AB23XMV5CDKHKB'),
    'ticketmastertoken'=> \Cake\Core\Configure::read('TICKETMASTER_AUTH_KEY','RPFWQ9ss8NIuTaLpBjUv7xEDYtHvUgrg'),    
