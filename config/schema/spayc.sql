...
SELECT create_hypertable('settings', 'created');
INSERT INTO "settings" ("param","param_value","created") VALUES ('app_version','1.0',now());
...
CREATE TABLE warp_frequency(
    ...
    repeat_date  character varying(200) NULL DEFAULT NULL,
    created timestamp NOT NULL,
